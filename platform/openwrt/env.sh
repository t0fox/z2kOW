...
AUTOHOSTLIST_DOMAINS_FILE="${AUTOHOSTLIST_DOMAINS_FILE:-$Z2K_AUTOHOSTLIST_DOMAINS_FILE}"
export Z2K_EXTRA_DOMAINS_SHIPPED Z2K_EXTRA_DOMAINS_RUNTIME \
    Z2K_EXTRA_STRATEGIES_RUNTIME Z2K_AUTOHOSTLIST_DOMAINS_FILE \
    AUTOHOSTLIST_DOMAINS_FILE Z2K_NFQWS2 Z2K_CONFIG Z2K_STATE
export Z2K_NFQWS2
...
z2k_ow_core_ready() {
    ...
    z2k_ow_nfqws_consumer_ready || return 1
    command -v z2k_ow_customd_runtime_ready >/dev/null 2>&1 || return 0
