...
assert_contains "OpenWrt custom.d capability is computed" "$PLAT" 'z2k_ow_customd_available'
assert_contains "OpenWrt custom.d toggle checks components" "$PLAT" 'обязательные файлы или runtime отсутствуют'
