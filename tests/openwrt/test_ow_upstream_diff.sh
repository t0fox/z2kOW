...
#   z2k-warpd/cmd/z2k-warpd/warp_domain_paths_test.go: execute the domain
#     observer with procd's runtime paths and guard Keenetic defaults.
...
ALLOWLIST="$ALLOWLIST z2k-warpd/cmd/z2k-warpd/warp_domain_paths_test.go z2k-warpd/internal/domainroute/nft_pairset.go z2k-warpd/internal/domainroute/nft_pairset_test.go z2k-warpd/openwrt-overlay/overlay.json z2k-warpd/openwrt-overlay/ipset.go z2k-warpd/openwrt-overlay/go.mod"
...
if [ -z "$_all" ]; then
    ...
    for _f in $_bad; do
        case "$_f" in
            ...
            z2k-warpd/cmd/z2k-warpd/warp_domain_paths_test.go|z2k-warpd/internal/domainroute/nft_pairset.go|z2k-warpd/internal/domainroute/nft_pairset_test.go|z2k-warpd/openwrt-overlay/overlay.json|z2k-warpd/openwrt-overlay/ipset.go|z2k-warpd/openwrt-overlay/go.mod) continue ;;
