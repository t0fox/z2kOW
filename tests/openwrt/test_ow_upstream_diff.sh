...
ALLOWLIST="$ALLOWLIST lib/install.sh lib/menu.sh files/z2k-insta-ip-refresh.sh webpanel/www/index.html webpanel/www/js/pages/update.js webpanel/www/style.css tests/test_panel_toggle_texts.sh tests/test_insta_refresh_cert_mismatch.sh tests/test_fastroute_no_hwnat.sh tests/test_config_official.sh tests/test_found_domains_survive_reinstall.sh tests/test_panel_domain_probe.sh tests/test_profile_observation.sh tests/test_quic_pool_general.sh tests/test_update_sequence_e2e.sh tests/test_update_jitter.sh z2k-detect/cmd/z2k-detect/z2k_hostlists.go z2k-detect/go.mod z2k-detect/go.sum z2k-detect/internal/decision/decision.go"
...
if [ -z "$_all" ]; then
    ...
    for _f in $_bad; do
        case "$_f" in
            ...
            tests/test_config_official.sh|tests/test_found_domains_survive_reinstall.sh|tests/test_panel_domain_probe.sh|tests/test_panel_modules_delivered.sh|tests/test_panel_toggle_texts.sh|tests/test_profile_observation.sh|tests/test_quic_pool_general.sh|tests/test_update_sequence_e2e.sh|tests/test_update_jitter.sh|webpanel/www/style.css|z2k-detect/cmd/z2k-detect/z2k_hostlists.go|z2k-detect/internal/decision/decision.go) continue ;;
            UPDATES.json)
