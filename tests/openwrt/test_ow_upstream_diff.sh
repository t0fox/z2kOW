...
ALLOWLIST="$ALLOWLIST lib/install.sh files/z2k-insta-ip-refresh.sh webpanel/www/index.html webpanel/www/js/pages/update.js tests/test_insta_refresh_cert_mismatch.sh tests/test_fastroute_no_hwnat.sh"
