...
ALLOWLIST="$ALLOWLIST files/lua/z2k-modern-core.lua files/lua/z2k-state-persist.lua tests/test_webpanel_state.sh"
...
if [ -z "$_all" ]; then
    ...
    for _f in $_bad; do
        case "$_f" in
            ...
            files/lua/z2k-modern-core.lua|files/lua/z2k-state-persist.lua|tests/test_profile_observation.lua|tests/test_webpanel_state.sh) continue ;;
