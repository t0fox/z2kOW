...
# The ownership-safe legacy discovery retirement must be installable over r72.
assert_eq "adapter release bumped for ownership-safe discovery retirement" "73" "$_arel"
