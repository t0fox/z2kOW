...
assert_eq "adapter release bumped for WARP fw4 forwarding admission" "49" "$_arel"
...
assert_file "WARP fw4 chain-pre include exists" \
    "$REPO/package/openwrt/files/etc/nftables.d/chain-pre/forward/90-z2k-warp.nft"
