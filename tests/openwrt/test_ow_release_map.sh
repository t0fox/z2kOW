...
assert_eq "manifest tcp" "/usr/lib/z2k/manifests/strats_new2.txt" "$(_ow strats_new2.txt)"
assert_eq "manifest quic" "/usr/lib/z2k/manifests/quic_strats.ini" "$(_ow quic_strats.ini)"
