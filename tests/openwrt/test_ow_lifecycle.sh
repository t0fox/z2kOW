...
assert_contains "service: auto-hostlist prepare before generate" "$SVC" "z2k_ow_autohostlist_prepare"
assert_contains "service: auto-hostlist sync on stop" "$SVC" "z2k_ow_autohostlist_sync"
