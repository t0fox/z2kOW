...
assert_contains "OpenWrt exposes stock offload capability" "$CPSH" '"offload":%s'
assert_contains "OpenWrt offload mutation route" "$REPO/webpanel/cgi/api.sh" '"POST /offload")'
assert_contains "OpenWrt offload selector" "$REPO/webpanel/www/js/pages/toggles.js" 'apiPost("/offload"'
